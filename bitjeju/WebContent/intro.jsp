...
function kakaoMap(){
	...
	var iwContent = '<div style="padding:5px;">비트캠프 제주점</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
...
<%@ include file="template/menu.jspf" %>
   ...
   <!--*****************비트캠프 메뉴******************-->
      ...
      <div id="intro_table" >
		...
		<tr>
		<th>지하철</th>
		<td>(신논현역) 9호선 6번출구 – 강남역 방향 도보 3분<br/>(강남역) 2호선 10번출구 – 신논현역 방향 도보 7분</td>
		</tr>
		<tr>
		<th>버스</th>
